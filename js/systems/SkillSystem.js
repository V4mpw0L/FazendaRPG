...
export default class SkillSystem {
    ...
    getXPProgress(skillId) {
        ...
        const currentLevelXP = this.xpTable[currentLevel - 1] || calculateXPForLevel(currentLevel);
        const nextLevelXP = this.xpTable[currentLevel] || calculateXPForLevel(currentLevel + 1);
    ...
    getHighestSkill() {
        ...
        return stats.reduce((highest, skill) => {
