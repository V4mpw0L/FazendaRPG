...
export default class InventorySystem {
    ...
    addItem(itemId, amount = 1) {
        ...
        // Dispatch event
        window.dispatchEvent(new CustomEvent('inventory:itemAdded', {
    ...
    removeItem(itemId, amount = 1) {
        ...
        // Dispatch event
        window.dispatchEvent(new CustomEvent('inventory:itemRemoved', {
            detail: { itemId, amount }
        }));
    ...
    useItem(itemId) {
        ...
        // Dispatch event
        window.dispatchEvent(new CustomEvent('inventory:itemUsed', {
    ...
    sellItem(itemId, amount = 1) {
        ...
        // Dispatch event
        window.dispatchEvent(new CustomEvent('inventory:itemSold', {
    ...
    getItemStackInfo(itemId) {
        ...
        return {
            ...
            percentage: itemData.maxStack ? (currentCount / itemData.maxStack) * 100 : 0
        };
    }
