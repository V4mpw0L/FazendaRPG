...
import { clamp, calculateLevelFromXP, calculateXPForLevel } from '../utils/helpers.js';
...
export default class Player {
     ...
     */
    getTotalLevel() {
        return Object.values(this.data.skills).reduce((sum, skill) => sum + skill.level, 0);
    }
    ...
    onSkillLevelUp(skill, newLevel) {
        ...
        // Dispatch event for UI
        window.dispatchEvent(new CustomEvent('player:skillLevelup', {
